...
export const INITIAL_DEPARTMENTS: DepartmentInfo[] = [
  { id: 'dept-1', name: 'Operating Room (ห้องผ่าตัด)', category: 'Surgical', buildingFloor: 'อาคาร 1 ชั้น 3' },
  { id: 'dept-2', name: 'Gastrointestinal & Liver Center (Scope / ศูนย์ส่องกล้อง)', category: 'Endoscopy', buildingFloor: 'อาคาร 2 ชั้น 2' },
  { id: 'dept-3', name: 'BME-PTP (ฝ่ายเครื่องมือแพทย์)', category: 'Engineering', buildingFloor: 'อาคาร 1 ชั้น B' },
  { id: 'dept-4', name: 'X-Ray (แผนกรังสีวินิจฉัย)', category: 'Radiology', buildingFloor: 'อาคาร 1 ชั้น 1' },
  { id: 'dept-5', name: 'Cardio-Neuro Vascular Intervention (CathLab)', category: 'Critical Care', buildingFloor: 'อาคาร 1 ชั้น 4' },
  { id: 'dept-6', name: 'Emergency & Ambulance (ER / อุบัติเหตุฉุกเฉิน)', category: 'Emergency', buildingFloor: 'อาคาร 1 ชั้น 1' },
  { id: 'dept-7', name: 'Dental & Implant Center (ศูนย์ทันตกรรม)', category: 'Dental', buildingFloor: 'อาคาร 2 ชั้น 4' },
  { id: 'dept-8', name: 'Skin (ศูนย์ผิวหนัง & เลเซอร์)', category: 'OPD Specialized', buildingFloor: 'อาคาร 2 ชั้น 3' },
  { id: 'dept-9', name: 'Eye Ear Nose Throat Clinic (EENT / ตา หู คอ จมูก)', category: 'OPD Specialized', buildingFloor: 'อาคาร 1 ชั้น 2' },
  { id: 'dept-10', name: 'Anesthesia (แผนกดมยา)', category: 'Critical Care', buildingFloor: 'อาคาร 1 ชั้น 3' },
  { id: 'dept-11', name: 'Heart Center (ศูนย์หัวใจ)', category: 'Cardiology', buildingFloor: 'อาคาร 2 ชั้น 2' },
  { id: 'dept-12', name: 'I.C.U (หอผู้ป่วยวิกฤต)', category: 'Inpatient Critical', buildingFloor: 'อาคาร 1 ชั้น 4' },
  { id: 'dept-13', name: 'Nursery (ทารกแรกเกิด)', category: 'Pediatrics', buildingFloor: 'อาคาร 2 ชั้น 5' },
  { id: 'dept-14', name: 'Neurology (ศูนย์สมองและระบบประสาท)', category: 'Specialized', buildingFloor: 'อาคาร 2 ชั้น 3' },
  { id: 'dept-15', name: 'Obstetric & Gynecology Center (ศูนย์สูติ-นรีเวช)', category: 'OB-GYN', buildingFloor: 'อาคาร 2 ชั้น 5' },
  { id: 'dept-16', name: 'Physiotherapy (เวชศาสตร์ฟื้นฟู & กายภาพบำบัด)', category: 'Rehabilitation', buildingFloor: 'อาคาร 1 ชั้น 2' },
  { id: 'dept-17', name: 'Bone & Joint (ศูนย์กระดูกและข้อ)', category: 'Orthopedics', buildingFloor: 'อาคาร 1 ชั้น 2' },
  { id: 'dept-18', name: 'Check Up Center (ศูนย์ตรวจสุขภาพ)', category: 'Preventive', buildingFloor: 'อาคาร 2 ชั้น 1' },
  { id: 'dept-19', name: 'General Surgery (ศัลยกรรมทั่วไป)', category: 'Surgical', buildingFloor: 'อาคาร 1 ชั้น 2' },
  { id: 'dept-20', name: 'General Medicine (OPD อายุรกรรม)', category: 'OPD', buildingFloor: 'อาคาร 1 ชั้น 2' },
  { id: 'dept-21', name: 'Pharmacy (คลังยา & เภสัชกรรม)', category: 'Pharmacy', buildingFloor: 'อาคาร 1 ชั้น 1' },
  { id: 'dept-22', name: 'Patient Wards 15 / 17 / 19 (หอผู้ป่วยใน)', category: 'Inpatient', buildingFloor: 'อาคาร 1 ชั้น 15-19' },
  { id: 'dept-23', name: 'Labour Room (ห้องคลอด)', category: 'OB-GYN', buildingFloor: 'อาคาร 2 ชั้น 5' },
  { id: 'dept-24', name: 'Air compressor room (ห้องระบบก๊าซทางการแพทย์)', category: 'Facility', buildingFloor: 'อาคาร 4 ชั้น 1' },
];

export const INITIAL_EQUIPMENT: EquipmentInfo[] = [
  { id: 'eq-1', code: 'EQ-OR-01', name: 'โคมไฟผ่าตัด & คอนโซลควบคุม OR', brand: 'SMKT / Getinge', category: 'Surgical Lights', department: 'Operating Room (ห้องผ่าตัด)', vendorCompany: 'SMKT Thailand' },
  { id: 'eq-2', code: 'EQ-OR-02', name: 'เตียงผ่าตัดระบบไฟฟ้า (Surgical Table)', brand: 'Getinge / Maquet', category: 'Surgical Table', department: 'Operating Room (ห้องผ่าตัด)', vendorCompany: 'Getinge (Thailand)' },
  { id: 'eq-3', code: 'EQ-OR-03', name: 'กล้องจุลทรรศน์ผ่าตัด (Surgical Microscope)', brand: 'Carl Zeiss', category: 'Microscope', department: 'Operating Room (ห้องผ่าตัด)', vendorCompany: 'Carl Zeiss' },
  { id: 'eq-4', code: 'EQ-OR-04', name: 'เครื่องสลายต้อกระจก (Phacoemulsification)', brand: 'Alcon', category: 'Ophthalmology', department: 'Operating Room (ห้องผ่าตัด)', vendorCompany: 'Alcon' },
  { id: 'eq-5', code: 'EQ-GI-01', name: 'ชุดกล้องส่องตรวจระบบทางเดินอาหาร (Evis X1)', brand: 'Olympus', category: 'Endoscopy', department: 'Gastrointestinal & Liver Center (Scope / ศูนย์ส่องกล้อง)', vendorCompany: 'Olympus (Thailand)' },
  { id: 'eq-6', code: 'EQ-GI-02', name: 'ระบบบันทึกภาพและรายงาน EndoSMART', brand: 'Kainatic', category: 'Software & Medical IT', department: 'Gastrointestinal & Liver Center (Scope / ศูนย์ส่องกล้อง)', vendorCompany: 'Kainatic MMS' },
  { id: 'eq-7', code: 'EQ-XR-01', name: 'เครื่องเอกซเรย์ระบบดิจิทัล (Digital Radiography)', brand: 'Philips DigitalDiagnost', category: 'X-Ray Imaging', department: 'X-Ray (แผนกรังสีวินิจฉัย)', vendorCompany: 'Philips Healthcare' },
  { id: 'eq-8', code: 'EQ-XR-02', name: 'เครื่องเอกซเรย์แมมโมแกรม (Mammogram)', brand: 'Fujifilm / Hologic', category: 'Mammography', department: 'X-Ray (แผนกรังสีวินิจฉัย)', vendorCompany: 'MD Healthcare' },
  { id: 'eq-9', code: 'EQ-XR-03', name: 'เครื่องฉีดสารทึบรังสี (CT/MR Injector)', brand: 'Bayer Medrad', category: 'Contrast Injector', department: 'X-Ray (แผนกรังสีวินิจฉัย)', vendorCompany: 'Bayer Thai' },
  { id: 'eq-10', code: 'EQ-XR-04', name: 'เครื่องตรวจสนามแม่เหล็กไฟฟ้า (MRI 1.5T/3T)', brand: 'Philips Ingenia', category: 'MRI', department: 'X-Ray (แผนกรังสีวินิจฉัย)', vendorCompany: 'Philips Healthcare' },
  { id: 'eq-11', code: 'EQ-CL-01', name: 'เครื่องตรวจหลอดเลือดหัวใจและสมอง (CathLab Azurion)', brand: 'Philips Azurion', category: 'Interventional Angiography', department: 'Cardio-Neuro Vascular Intervention (CathLab)', vendorCompany: 'Philips Healthcare' },
  { id: 'eq-12', code: 'EQ-CL-02', name: 'เครื่องตรวจคลื่นไฟฟ้าหัวใจขณะออกกำลังกาย (EST / CPET)', brand: 'GE Healthcare / SMD', category: 'Cardiology', department: 'Heart Center (ศูนย์หัวใจ)', vendorCompany: 'SMD Rise' },
  { id: 'eq-13', code: 'EQ-ICU-01', name: 'เครื่องเฝ้าติดตามสัญญาณชีพผู้ป่วย (Patient Monitor / Central Monitor)', brand: 'Mindray / Xovic', category: 'Patient Monitoring', department: 'I.C.U (หอผู้ป่วยวิกฤต)', vendorCompany: 'Xovic Co., Ltd.' },
  { id: 'eq-14', code: 'EQ-ICU-02', name: 'เครื่องช่วยหายใจชนิดควบคุมแรงดันและปริมาตร (Ventilator)', brand: 'Draeger Evita', category: 'Ventilator', department: 'I.C.U (หอผู้ป่วยวิกฤต)', vendorCompany: 'Draeger Medical' },
  { id: 'eq-15', code: 'EQ-AN-01', name: 'เครื่องดมยาสลบพร้อมระบบช่วยหายใจ (Anesthesia Workstation)', brand: 'Draeger / GE Datex', category: 'Anesthesia', department: 'Anesthesia (แผนกดมยา)', vendorCompany: 'Draeger Medical' },
  { id: 'eq-16', code: 'EQ-DEN-01', name: 'ยูนิตทำฟันและเก้าอี้ทันตกรรมระบบอัตโนมัติ', brand: 'Dentsply Sirona / SD', category: 'Dental Chair Unit', department: 'Dental & Implant Center (ศูนย์ทันตกรรม)', vendorCompany: 'SD Tantavade 1988' },
  { id: 'eq-17', code: 'EQ-SK-01', name: 'เครื่องเลเซอร์รักษาความผิดปกติของผิวหนัง (Q-Switched / Pico Laser)', brand: 'Lutronic / Candela', category: 'Dermatology Laser', department: 'Skin (ศูนย์ผิวหนัง & เลเซอร์)', vendorCompany: 'Laser Engineer' },
  { id: 'eq-18', code: 'EQ-BME-01', name: 'ปั๊มผลิตสุญญากาศและระบบอัดอากาศทางการแพทย์ (Medical Air & Vacuum Pump)', brand: 'BeaconMedaes', category: 'Medical Gas Plant', department: 'Air compressor room (ห้องระบบก๊าซทางการแพทย์)', vendorCompany: 'Double U Tech' },
  { id: 'eq-19', code: 'EQ-BME-02', name: 'เครื่องกระตุกหัวใจด้วยไฟฟ้า (Defibrillator & AED)', brand: 'Philips / Zoll', category: 'Resuscitation', department: 'Emergency & Ambulance (ER / อุบัติเหตุฉุกเฉิน)', vendorCompany: 'eNovations' },
  { id: 'eq-20', code: 'EQ-ENT-01', name: 'ตู้และเครื่องตรวจสมรรถภาพการได้ยิน (Audiometer Sound Proof Cabin)', brand: 'Audimed / Interacoustics', category: 'Audiology', department: 'Eye Ear Nose Throat Clinic (EENT / ตา หู คอ จมูก)', vendorCompany: 'Audimed Co., Ltd.' },
  { id: 'eq-21', code: 'EQ-OB-01', name: 'เครื่องตรวจคลื่นเสียงความถี่สูง 4 มิติ (Ultrasound Voluson E10)', brand: 'GE Healthcare / IDS', category: 'Ultrasound OB/GYN', department: 'Obstetric & Gynecology Center (ศูนย์สูติ-นรีเวช)', vendorCompany: 'IDS Medical Systems' },
];
...
const RAW_VISITOR_ROWS: Array<{
  ...
  { timestamp: "25/2/2025, 16:40:51", name: "ซื่อตรง ใจดี", company: "มีจะกิน", phone: "081-0000001", department: "Bone & Joint", workType: "DEMO", visitorCount: 1, cardImageUrl: "https://drive.google.com/open?id=1A6IGrW4nq0ka6m2jEKxUn7-gKdtjgkxu", vehicleType: "รถยนต์ส่วนบุคคล", licensePlate: "กข 1102 กทม" },
  { timestamp: "25/2/2025, 16:43:06", name: "ซื่อตรง ใจซื่อดี", company: "มีจะกิน จำกัด", phone: "081-0000001", department: "Check Up Center", workType: "งานซ่อม", visitorCount: 2, cardImageUrl: "https://drive.google.com/open?id=1HWsrxu-YrUWG36HTZnQ9W_5wlSLVD_M9", vehicleType: "รถยนต์ส่วนบุคคล", licensePlate: "กง 8991" },
  { timestamp: "25/2/2025, 16:46:38", name: "มาลี มีเงิน", company: "พอดีคำ", phone: "082-1234567", department: "Ear Nose Throat", workType: "DEMO", visitorCount: 1, cardImageUrl: "https://drive.google.com/open?id=1nU7Vk15WAig9i8drWe6Hjz1wlVeLKbIW", vehicleType: "จักรยานยนต์", licensePlate: "1กข 3456" },
